...
//postlab edit
Sjump.prototype.type = "sjump";

Sjump.prototype.act = function(step){
	this.wobble += step * wobbleSpeed;
	//set where the position is and is moving too
	var wobblePos = Math.sin(this.wobble) * wobbleDist;
	//wobbles up and down, not left and right
...
function Rock(pos, ch){
	this.pos = pos;
	this.size = new Vector(1.5,2.1);
	if (ch == "R"){
		this.speed = new Vector(0,2);
	}
}
Rock.prototype.type = "rock";
function Rock2(pos, ch){
	this.pos = pos;
	this.size = new Vector(1.5,2.1);
	if (ch == "r"){
		this.speed = new Vector(0,2);
...
Rock2.prototype.type = "rock2";

function Text(pos,ch){
	this.pos = pos;
	this.size = new Vector(15,3.1);
	if (ch == "T"){
		this.speed = new Vector(0,0);
	}
}
...
function Text2(pos,ch){
	this.pos = pos;
	this.size = new Vector(10.1,1.8);
	if (ch == "t"){
		this.speed = new Vector(0,0);
	}
}

Text2.prototype.type = "text2";
function Text3(pos,ch){
	this.pos = pos;
	this.size = new Vector(10.1,1.8);
	if (ch == "y"){
		this.speed = new Vector(0,0);
...
Text3.prototype.type = "text3";

function Text4(pos,ch){
	this.pos = pos;
	this.size = new Vector(15,2.6);
	if (ch == "Y"){
		this.speed = new Vector(0,0);
	}
}

Text4.prototype.type = "text4";

function Text5(pos,ch){
	this.pos = pos;
	this.size = new Vector(15,2.6);
	if (ch == "z"){
		this.speed = new Vector(0,0);
...
function Finaltext(pos,ch){
	this.pos = pos;
	this.size = new Vector(30,17.5);
	if (ch == "Z"){
		this.speed = new Vector(0,0);
	}
}

Finaltext.prototype.type = "finaltext";
...
Rock.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
Rock2.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
    this.pos = newPos;
};

Text.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
Text2.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
Text3.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
Text4.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
Text5.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
Finaltext.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
